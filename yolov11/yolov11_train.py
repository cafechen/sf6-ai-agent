...
train_results = model.train(
    data="/home/steven/dataset/data.yaml",  # Path to dataset configuration file
    ...
    batch=64, # Specifies export model batch inference size or the maximum number of images the exported model will process concurrently in predict mode. For Edge TPU exports, this is automatically set to 1.
